...
# Base customizer vars
GLOBAL_FONT = 'Nunito'
GLOBAL_BORDER_THICKNESS = '1'
GLOBAL_BORDER_COLOR = '4B8B2A'
GLOBAL_BORDER_RADIUS = '5'
LOGIN_ENABLE = True
LOGIN_BACKGROUND = '31383B'
LOGIN_TEXT = 'D6D6D6'
LOGIN_LINK = 'D6D6D6'
LOGIN_LINK_HOVER = 'F0F0F0'
LOGIN_ICBU = 'DDA62A'
LOGIN_ICBU_HOVER = '4B8B2A'
TOP_BACKGROUND = '333333'
TOP_TEXT = 'D6D6D6'
TOP_LINK = 'D6D6D6'
TOP_LINK_HOVER = 'F0F0F0'
TOP_ICON = 'DDA62A'
TOP_ICON_HOVER = '4B8B2A'
TOP_BUTTON = '4B8B2A'
TOP_BUTTON_HOVER = 'DDA62A'
NAV_BACKGROUND = '333333'
NAV_TEXT = 'D6D6D6'
NAV_LINK = 'D6D6D6'
NAV_LINK_HOVER = '4B8B2A'
NAV_ICBU = 'DDA62A'
NAV_ICBU_HOVER = 'DDA62A'
MAIN_BACKGROUND = '292929'
MAIN_TEXT = 'D6D6D6'
MAIN_LINK = 'DDA62A'
MAIN_LINK_HOVER = 'F0F0F0'
MAIN_ICBU = '7D5E18'
MAIN_ICBU_HOVER = '4B8B2A'
MAIN_TABLE_BORDER_COLOR = '333333'
MAIN_TABLE_BORDER_THICKNESS = '1'
POPUPS_BACKGROUND = '333333'
POPUPS_TEXT = 'D6D6D6'
POPUPS_LINK = 'D6D6D6'
POPUPS_LINK_HOVER = 'DDA62A'
POPUPS_ICBU = 'DDA62A'
POPUPS_ICBU_HOVER = '4B8B2A'
...
CONSTANCE_CONFIG = {
    ...
    'GLOBAL_BORDER_THICKNESS': (GLOBAL_BORDER_THICKNESS, ''),
    'GLOBAL_BORDER_COLOR': (GLOBAL_BORDER_COLOR, ''),
    'GLOBAL_BORDER_RADIUS': (GLOBAL_BORDER_RADIUS, ''),
    'LOGIN_ENABLE': (LOGIN_ENABLE, ''),
    'LOGIN_BACKGROUND': (LOGIN_BACKGROUND, ''),
    'LOGIN_TEXT': (LOGIN_TEXT, ''),
    'LOGIN_LINK': (LOGIN_LINK, ''),
    'LOGIN_LINK_HOVER': (LOGIN_LINK_HOVER, ''),
    'LOGIN_ICBU': (LOGIN_ICBU, ''),
    'LOGIN_ICBU_HOVER': (LOGIN_ICBU_HOVER, ''),
    'TOP_BACKGROUND': (TOP_BACKGROUND, ''),
    'TOP_TEXT': (TOP_TEXT, ''),
    'TOP_LINK': (TOP_LINK, ''),
    'TOP_LINK_HOVER': (TOP_LINK_HOVER, ''),
    'TOP_ICON': (TOP_ICON, ''),
    'TOP_BUTTON': (TOP_BUTTON, ''),
    'TOP_ICON_HOVER': (TOP_ICON_HOVER, ''),
    'TOP_BUTTON_HOVER': (TOP_BUTTON_HOVER, ''),
    'NAV_BACKGROUND': (NAV_BACKGROUND, ''),
    'NAV_TEXT': (NAV_TEXT, ''),
    'NAV_LINK': (NAV_LINK, ''),
    'NAV_LINK_HOVER': (NAV_LINK_HOVER, ''),
    'NAV_ICBU': (NAV_ICBU, ''),
    'NAV_ICBU_HOVER': (NAV_ICBU_HOVER, ''),
    'MAIN_BACKGROUND': (MAIN_BACKGROUND, ''),
    'MAIN_TEXT': (MAIN_TEXT, ''),
    'MAIN_LINK': (MAIN_LINK, ''),
    'MAIN_LINK_HOVER': (MAIN_LINK_HOVER, ''),
    'MAIN_ICBU': (MAIN_ICBU, ''),
    'MAIN_ICBU_HOVER': (MAIN_ICBU_HOVER, ''),
    'MAIN_TABLE_BORDER_COLOR': (MAIN_TABLE_BORDER_COLOR, ''),
    'MAIN_TABLE_BORDER_THICKNESS': (MAIN_TABLE_BORDER_THICKNESS, ''),
    'POPUPS_BACKGROUND': (POPUPS_BACKGROUND, ''),
    'POPUPS_TEXT': (POPUPS_TEXT, ''),
    'POPUPS_LINK': (POPUPS_LINK, ''),
    'POPUPS_LINK_HOVER': (POPUPS_LINK_HOVER, ''),
    'POPUPS_ICBU': (POPUPS_ICBU, ''),
    'POPUPS_ICBU_HOVER': (POPUPS_ICBU_HOVER, ''),
