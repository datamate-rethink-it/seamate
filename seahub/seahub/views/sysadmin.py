...
def sys_settings(request):
    ...
    DIGIT_WEB_SETTINGS = [
        ...
        'ENABLE_BRANDING_CSS', 'ENABLE_TERMS_AND_CONDITIONS', 'LOGIN_ENABLE',
        'GLOBAL_BORDER_THICKNESS', 'MAIN_TABLE_BORDER_THICKNESS', 'GLOBAL_BORDER_RADIUS'
    ]

    STRING_WEB_SETTINGS = ('SERVICE_URL', 'FILE_SERVER_ROOT', 'TEXT_PREVIEW_EXT',
                           'SITE_NAME', 'SITE_TITLE', 'CUSTOM_CSS')

    COLOR_CODES_SETTINGS = ('GLOBAL_FONT',  'GLOBAL_BORDER_COLOR', 'LOGIN_BACKGROUND', 'LOGIN_TEXT',
                            'LOGIN_LINK', 'LOGIN_LINK_HOVER', 'LOGIN_ICBU', 'LOGIN_ICBU_HOVER',
                            'TOP_BACKGROUND', 'TOP_TEXT', 'TOP_LINK', 'TOP_LINK_HOVER', 'TOP_ICBU',
                            'TOP_ICBU_HOVER', 'NAV_BACKGROUND', 'NAV_TEXT', 'NAV_LINK', 'NAV_LINK_HOVER',
                            'NAV_ICBU', 'NAV_ICBU_HOVER', 'MAIN_BACKGROUND', 'MAIN_TEXT', 'MAIN_LINK',
                            'MAIN_LINK_HOVER', 'MAIN_ICBU', 'MAIN_ICBU_HOVER', 'MAIN_TABLE_BORDER_COLOR',
                            'POPUPS_BACKGROUND', 'POPUPS_TEXT', 'POPUPS_LINK',
    ...
    if request.is_ajax() and request.method == "POST":
        ...
        if value.isdigit():
            if key in COLOR_CODES_SETTINGS:
                value = str(value)
            elif key in DIGIT_WEB_SETTINGS:
                value = int(value)
            else:
            ...
            if key in COLOR_CODES_SETTINGS:
                ...
                key = ['GLOBAL_FONT', 'GLOBAL_BORDER_THICKNESS', 'GLOBAL_BORDER_COLOR', 'GLOBAL_BORDER_RADIUS', 'LOGIN_BACKGROUND', 'LOGIN_TEXT', 'LOGIN_LINK', 'LOGIN_LINK_HOVER', 'LOGIN_ICBU', 'LOGIN_ICBU_HOVER', 'TOP_BACKGROUND', 'TOP_TEXT', 'TOP_LINK', 'TOP_LINK_HOVER', 'TOP_ICBU', 'TOP_ICBU_HOVER', 'NAV_BACKGROUND', 'NAV_TEXT', 'NAV_LINK', 'NAV_LINK_HOVER', 'NAV_ICBU', 'NAV_ICBU_HOVER', 'MAIN_BACKGROUND', 'MAIN_TEXT', 'MAIN_LINK', 'MAIN_LINK_HOVER', 'MAIN_ICBU', 'MAIN_ICBU_HOVER', 'MAIN_TABLE_BORDER_COLOR', 'MAIN_TABLE_BORDER_THICKNESS', 'POPUPS_BACKGROUND', 'POPUPS_TEXT', 'POPUPS_LINK', 'POPUPS_LINK_HOVER', 'POPUPS_ICBU', 'POPUPS_ICBU_HOVER']
                if value == 'electricviolet':
                    ...
                    result['error'] = _(u'Invalid value')
                    return HttpResponse(json.dumps(result), status=400, content_type=content_type)
            elif key not in STRING_WEB_SETTINGS:
                result['error'] = _(u'Invalid value')
                return HttpResponse(json.dumps(result), status=400, content_type=content_type)
