...
def sys_settings(request):
    ...
    COLOR_CODES_SETTINGS = ('GLOBAL_FONT',  'GLOBAL_BORDER_COLOR', 'LOGIN_BACKGROUND', 'LOGIN_TEXT',
                            ...
                            'TOP_BACKGROUND', 'TOP_TEXT', 'TOP_LINK', 'TOP_LINK_HOVER', 'TOP_ICON',
                            'TOP_ICON_HOVER', 'TOP_BUTTON', 'TOP_BUTTON_HOVER', 'NAV_BACKGROUND', 'NAV_TEXT', 'NAV_LINK', 'NAV_LINK_HOVER',
        ...
        if value.isdigit():
            ...
            if key in COLOR_CODES_SETTINGS:
                ...
                if value == 'electricviolet':
                    value = ['Rubik', '3', 'B0A8B9', '5', '282E30', 'E6E6E6', '0187FF', '7CE2FF', '222729', '1A1A1A', '7F1DCC', 'FCEAFF', 'FCEAFF', 'FF0077', 'EBC9FF', 'B08FC4', '57148C', '310B4F', '382B47', 'FCEAFF', 'FCEAFF', 'FF0077', 'FCEAFF', '57148C', '57148C', 'FCEAFF', 'FF0077', 'FCEAFF', 'FF0077', 'FCEAFF', '382B47', '2', '7F1DCC', 'FCEAFF', 'FF0077', 'FCEAFF', 'FCEAFF', 'FF0077']
